...
export const VEDIC_MAPPINGS: VedicMapping[] = [
  ...
  // Vedic Marks
  { itrans: "\\'", unicode: '\u0951', name: 'udatta', category: 'vedic' },
  { itrans: "'", unicode: '\u0951', name: 'udatta', category: 'vedic' },
  { itrans: "\\_", unicode: '\u0952', name: 'anudatta', category: 'vedic' },
  { itrans: "_", unicode: '\u0952', name: 'anudatta', category: 'vedic' },
  { itrans: "\\^", unicode: '\uF176', name: 'svarita', category: 'vedic' },
  { itrans: "^", unicode: '\uF176', name: 'svarita', category: 'vedic' },
...
export const MAPPING_TRIE = [...VEDIC_MAPPINGS].sort((a, b) => b.itrans.length - a.itrans.length);
