...
export const VEDIC_MAPPINGS: VedicMapping[] = [
  ...
  { itrans: ":''", unicode: '\u0903\u200C\uF176', preferredReverse: true, category: 'mark' },
  ...
  { itrans: '"', unicode: '\uF176', name: 'double svarita', category: 'vedic' },
...
export const TAMIL_MAPPINGS: VedicMapping[] = [
  // Vowels
  { itrans: 'a', unicode: '\u0B85', preferredReverse: true, name: 'a', category: 'vowel' },
  { itrans: 'A', unicode: '\u0B86', preferredReverse: true, name: 'aa', category: 'vowel' },
  { itrans: 'i', unicode: '\u0B87', preferredReverse: true, name: 'i', category: 'vowel' },
  { itrans: 'I', unicode: '\u0B88', preferredReverse: true, name: 'ii', category: 'vowel' },
  { itrans: 'u', unicode: '\u0B89', preferredReverse: true, name: 'u', category: 'vowel' },
  { itrans: 'U', unicode: '\u0B8A', preferredReverse: true, name: 'uu', category: 'vowel' },
  { itrans: 'e', unicode: '\u0B8E', preferredReverse: true, name: 'short e', category: 'vowel' },
  { itrans: 'E', unicode: '\u0B8F', preferredReverse: true, name: 'e', category: 'vowel' },
  { itrans: 'ai', unicode: '\u0B90', preferredReverse: true, name: 'ai', category: 'vowel' },
  { itrans: 'o', unicode: '\u0B92', preferredReverse: true, name: 'short o', category: 'vowel' },
  { itrans: 'O', unicode: '\u0B93', preferredReverse: true, name: 'o', category: 'vowel' },
  ...
  { itrans: 'sh', unicode: '\u0BB6\u0BCD', preferredReverse: true, name: 'sha', category: 'consonant' },
  ...
  { itrans: 'OM', unicode: '\u0BD0', name: 'om', category: 'special' },
  ...
  // Vedic Marks (Precision placeholders)
  { itrans: "'", unicode: '\u0951', preferredReverse: true, name: 'svarita', category: 'vedic' },
  { itrans: "_", unicode: '\u0952', preferredReverse: true, name: 'anudatta', category: 'vedic' },
  { itrans: "''", unicode: '\u1CDA', preferredReverse: true, name: 'double svarita', category: 'vedic' },
  
  // Dependent Vowels (for Reference)
  { itrans: 'A', unicode: '\u0BBE', name: 'aa matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },
  { itrans: 'i', unicode: '\u0BBF', name: 'i matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },
  { itrans: 'I', unicode: '\u0BC0', name: 'ii matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },
  { itrans: 'u', unicode: '\u0BC1', name: 'u matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },
  { itrans: 'U', unicode: '\u0BC2', name: 'uu matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },
  { itrans: 'e', unicode: '\u0BC6', name: 'short e matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },
  { itrans: 'E', unicode: '\u0BC7', name: 'e matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },
  { itrans: 'ai', unicode: '\u0BC8', name: 'ai matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },
  { itrans: 'o', unicode: '\u0BCA', name: 'short o matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },
  { itrans: 'O', unicode: '\u0BCB', name: 'o matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },
  { itrans: 'au', unicode: '\u0BCC', name: 'au matra', category: 'mark', isScholarly: true, subCategory: 'Matra' },

  // Punctuation & Numbers
  { itrans: "||", unicode: '\u0965', preferredReverse: true, name: 'double danda', category: 'special' },
  { itrans: "|", unicode: '\u0964', preferredReverse: true, name: 'danda', category: 'special' },
  { itrans: '0', unicode: '\u0BE6', name: 'zero', category: 'number' },
  { itrans: '1', unicode: '\u0BE7', name: 'one', category: 'number' },
  { itrans: '2', unicode: '\u0BE8', name: 'two', category: 'number' },
  { itrans: '3', unicode: '\u0BE9', name: 'three', category: 'number' },
  { itrans: '4', unicode: '\u0BEA', name: 'four', category: 'number' },
  { itrans: '5', unicode: '\u0BEB', name: 'five', category: 'number' },
  { itrans: '6', unicode: '\u0BEC', name: 'six', category: 'number' },
  { itrans: '7', unicode: '\u0BED', name: 'seven', category: 'number' },
  { itrans: '8', unicode: '\u0BEE', name: 'eight', category: 'number' },
  { itrans: '9', unicode: '\u0BEF', name: 'nine', category: 'number' },
  { itrans: '10t', unicode: '\u0BF0', name: 'ten', category: 'number', isScholarly: true },
  { itrans: '100t', unicode: '\u0BF1', name: 'hundred', category: 'number', isScholarly: true },
  { itrans: '1000t', unicode: '\u0BF2', name: 'thousand', category: 'number', isScholarly: true },
];
